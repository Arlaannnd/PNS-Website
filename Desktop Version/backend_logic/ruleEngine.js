// Uses window.taskData instead of import

// --- MESIN ATURAN (SISTEM POIN LANGSUNG) ---
...
function hitungPrioritas(kegiatan) {
    ...
    // Otomatis buat format string agar data.js lebih rapi
