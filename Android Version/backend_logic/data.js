...
window.loadTaskData = async function() {
  try {
    // PERBAIKAN ANDROID: Menggunakan authService yang sudah terbukti bekerja
    // Tidak perlu lagi pusing dengan import path './' atau '../'
    ...
    if (data) {
      ...
      // Simpan bayangan data ke localStorage
